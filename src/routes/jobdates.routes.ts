...
//edit jobdate
router.put('/:id',authMiddleware,authorizeMiddleware(["Artist"]), jobdateController.update);

//delete date
router.delete('/:id',authMiddleware,authorizeMiddleware(["Client","Artist"]), jobdateController.delete);

//get jobdates by client
router.get('/client/jobdates',authMiddleware,authorizeMiddleware(["Client"]), jobdateController.getByLogedClient);
